...
Erkens, M., Bodemer, D., & Hoppe, H. U. (2016). Improving collaborative learning in the classroom: Text mining based grouping and representing. International Journal of Computer-Supported Collaborative Learning, 11, 387-415.  

2.  How does topic modeling address research questions?

The paper address how the analysis and visualization of cognitive information can be supported by automatic mechanisms (especially using text mining), and what effects a corresponding tool can achieve in the classroom.  
...
1.  What text data would need to be collected?
    ...
    written homework such as essays or wiki entries.  

2.  For what reason would text data need to be collected in order to address this question?

    -   These texts are externalizations of knowledge and provide unstructured data to be analyzed.

3.  Explain the analytical level at which these text data would need to be collected and analyzed.

    -  Identifying which parts of a text represent specific topics in a relative view. 
