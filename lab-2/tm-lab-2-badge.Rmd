...
2.  How does the sentiment analysis address research questions?
    ...
    -   The contribution of this paper is two-fold: (i) studying the sentiment polarity (positive, negative and neutral) from students’ data using machine learning techniques, and (ii) modelling and predicting students’ emotions (Amused, Anxiety, Bored, Confused, Enthused, Excited, Frustrated, etc.) using the big data frameworks.
...
1.  What text data would need to be collected?
    ...
    -   Messages collected from Twitter, Facebook and Moodle. 

2.  For what reason would text data need to be collected in order to address this question?

    - studying the sentiment polarity about specific course.  
